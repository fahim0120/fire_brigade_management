<?php echo form_open_multipart('license/apply_for_commercial'); ?>
<div class="form-horizontal">
<fieldset>

<!-- Form Name -->
<legend class="row text-center">Commercial License Application Form (Step 2 of 2)</legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="company_name" name="company_name" placeholder="" class="form-control input-md" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="business_type">Business Type</label>  
  <div class="col-md-4">
  <input id="business_type" name="business_type" placeholder="" class="form-control input-md" required="" type="text">
