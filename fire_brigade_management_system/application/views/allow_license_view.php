...
<?php echo form_open('license/issue_license'); ?>
<div class="form-horizontal">
<fieldset>

<!-- Form Name -->
<legend class="row text-center">Expire Date</legend>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="expiry_date">Expiry Date</label>  
  <div class="col-md-4">
  <input id="expiry_date" name="expiry_date" placeholder="" class="form-control input-md" type="date">
